...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class PatientsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Patients] WHERE (([PatientID] = @Original_PatientID) AND ([PatientNa"& _ 
                "me] = @Original_PatientName) AND ([Gender] = @Original_Gender) AND ([Age] = @Ori"& _ 
                "ginal_Age) AND ([Address] = @Original_Address) AND ([ContactNumber] = @Original_"& _ 
                "ContactNumber))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Patients] ([PatientName], [Gender], [Age], [Address], [ContactNumber"& _ 
                "]) VALUES (@PatientName, @Gender, @Age, @Address, @ContactNumber);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Patie"& _ 
                "ntID, PatientName, Gender, Age, Address, ContactNumber FROM Patients WHERE (Pati"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Patients] SET [PatientName] = @PatientName, [Gender] = @Gender, [Age] = @"& _ 
                "Age, [Address] = @Address, [ContactNumber] = @ContactNumber WHERE (([PatientID] "& _ 
                "= @Original_PatientID) AND ([PatientName] = @Original_PatientName) AND ([Gender]"& _ 
                " = @Original_Gender) AND ([Age] = @Original_Age) AND ([Address] = @Original_Addr"& _ 
                "ess) AND ([ContactNumber] = @Original_ContactNumber));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT PatientID, Patien"& _ 
                "tName, Gender, Age, Address, ContactNumber FROM Patients WHERE (PatientID = @Pat"& _ 
                "ientID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "Select * from Patients"
    ...
    Partial Public Class UsersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Users] ([Username], [Password]) VALUES (@Username, @Password);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELE"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Users] SET [Username] = @Username, [Password] = @Password WHERE (([UserID"& _ 
                "] = @Original_UserID) AND ([Username] = @Original_Username) AND ([Password] = @O"& _ 
                "riginal_Password));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT UserID, Username, Password FROM Users WHERE (UserID "& _ 
                "= @UserID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
